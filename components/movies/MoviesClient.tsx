...
import { PaginationMedia } from "../shared/pagination/PaginationMedia"


export function MoviesClient(){
    const { movies, search, setSearch, loading, page, nextPage, previousPage, setPage, totalPages } = useTmdbMovies()
